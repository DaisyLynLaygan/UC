...
<input type="text" name="eventID" value="<?php echo htmlspecialchars($eventID); ?>" required><br><br>

<label>Department ID:</label><br>
<input type="text" name="deptID" value="<?php echo htmlspecialchars($deptID); ?>" required><br><br>
